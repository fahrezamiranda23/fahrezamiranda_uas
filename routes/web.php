...
Route::get('cetak_pelajaran', [PelajaranController::class, 'cetak_pelajaran'])->name('cetak_pelajaran');


Route::resource('kurikulum', KurikulumController::class);
Route::get('cetak_kurikulum', [KurikulumController::class, 'cetak_kurikulum'])->name('cetak_kurikulum');
...
Route::get('cetak_hari', [HariController::class, 'cetak_hari'])->name('cetak_hari');
