...
<a class="btn btn-success btn-sm" href="{{ route('pengumuman.create') }}">Tambah Data</a>
<a href="{{ route('cetak_pengumuman') }}" class="btn btn-primary btn-sm">Cetak Pengumuman</a>
